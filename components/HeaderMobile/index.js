...
const HeaderMobile = () => {
  ...
  `;
    ...
    return (
        ...
        <nav className={` ${styles.navMobile} navbar navbar-expand-lg fixed-top`}>
            ...
            <div className="container-fluid">
                ...
                <button className={`${styles.buttonCollapse} navbar-toggler`} onClick={() => setShowCollapse(!showCollapse)}>
                    <MenuIcon />
                </button>
                <div className={styles.navCollapse} style={{right: showCollapse ? '0' : '100%'}}>
                    <Collapse expandIconPosition="right" accordion>
                        <Panel header="Marketplace" key="1">
                            {menuMarket}
                        </Panel>
                        <Panel header="Stats" key="2">
                            {menuStats}
                        </Panel>
                        <Panel header="Account" key="3">
                            {menuUser}
                        </Panel>
                        <Panel header="My Wallet" key="4">
                        </Panel>
                    </Collapse>
                </div>
            </div>
